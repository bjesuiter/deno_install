...
# This script uses 7z instead of 'unzip' to be executable on Synology DSM. 

set -e

if ! command -v 7z >/dev/null; then
	echo "Error: 7z is required to install Deno on DSM (see: https://github.com/denoland/deno_install#unzip-is-required )." 1>&2
	exit 1
fi
